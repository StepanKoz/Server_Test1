...
@Getter
@Configuration
@MapperScan(basePackages = {"com.example.demo.repository.write","com.example.demo.repository.read"})
public class DataConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryWrite() throws Exception {
        ...
        mappers.add("classpath*:com/example/demo/repository/write/*.xml");
        mappers.add("classpath*:com/example/demo/repository/read/*.xml");
